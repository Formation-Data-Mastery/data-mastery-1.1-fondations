...
| `notebooks/reference/04_comprendre_dialogue.ipynb` | Leçon 1.4 — Comprendre Claude |
...
| 1.4 | [Comprendre Claude](https://datamastery.dev/module-1/lecon-1-4-comprendre-claude) | 45 min |
